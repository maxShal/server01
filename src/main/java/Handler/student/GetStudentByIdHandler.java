...
public class GetStudentByIdHandler implements IHandler {
    ...
    public GetStudentByIdHandler(StudentControl studentControl) {
    ...
    public String hande(String json) throws JsonProcessingException {
        ...
        return mapper.writeValueAsString(studentControl.getBtId(mapper.readValue(json, GetStudentById.class)));
    }
}
